...
file_en_ru.write('<!doctype html><html xmlns="http://www.w3.org/1999/xhtml"><head><meta content="text/html; charset=utf-8" http-equiv="Content-Type"><title>openEHR Architecture Overview</title><style>img{width:70%;} table{width:100%; border-collapse:collapse; border: 1px solid #d3d3d3;} td{width:50%; vertical-align:top; word-wrap:break-word; padding:0 10px 0 10px;border-right: 1px solid #d3d3d3;} p,a,h1,h2,h3,h4,h5,h6 {word-wrap:break-word;font-family:Tahoma sans-serif;}</style></head><body>')
